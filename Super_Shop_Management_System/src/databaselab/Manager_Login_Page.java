...
public class Manager_Login_Page extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      try {  
             ...
             ResultSet rs = statement.executeQuery("SELECT  users,passwords FROM Login where login_id=3"); 
             String user_name="";
             String Password="";
             while (rs.next()) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Manager_Login_Page.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
